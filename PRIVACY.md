...
- Host access to `mail.google.com`: required to inject the palette, shortcuts, and tab bar into Gmail's interface. This is the entire scope; the extension runs nowhere else.

## Changes

Any change to this policy will appear in this file with an updated date, in the public source repository.

## Contact

Open an issue on the GitHub repository, or email hadij.pk@gmail.com.
