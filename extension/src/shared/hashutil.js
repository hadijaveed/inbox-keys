...
// other InboxKeys modules — so it loads first as a content script AND can be required
...
(function (root, factory) {
  ...
  if (typeof module !== "undefined" && module.exports) {
    ...
    root.InboxKeys = root.InboxKeys || {};
    root.InboxKeys.hashutil = api; // Gmail: window.InboxKeys.hashutil
  }
